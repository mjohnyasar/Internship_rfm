...
a=st.slider(label1, min_value=1, max_value=28, value=17,step=1, label_visibility="visible");
b=st.slider(label2, min_value=0, max_value=19, value=05,step=1, label_visibility="visible")
c=a*100+b
